...
/**
 * Parallax floating layer — children drift toward the pointer proportional to
 * their `depth`, eased per frame. Adapted from danielpetho/fancy for
 * framer-motion. Respects prefers-reduced-motion (holds elements still).
 */
