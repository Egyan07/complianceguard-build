...
/**
 * Kinetic rotating text — cycles through `texts`, animating in per-character
 * with a configurable stagger. Adapted from danielpetho/fancy for
 * framer-motion. Pass `auto={false}` (e.g. under reduced motion) to hold on
 * the first entry.
 */
